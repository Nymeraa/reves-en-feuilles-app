...
async function testPackagingPrice() {
    ...
    try {
        ...
        console.log(`  Price stored: ${movement.unitPriceAtTime}`);
        ...
        // Verify
        if (Math.abs((movement.unitPriceAtTime || 0) - testPrice) < 0.01 &&
            ...
            console.error(`   Movement price: ${movement.unitPriceAtTime} (expected ${testPrice})`);
