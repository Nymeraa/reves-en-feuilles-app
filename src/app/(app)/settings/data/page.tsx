      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Téléchargez une archive JSON contenant toutes vos données (Recettes, Ingrédients,
            Commandes, Packs). Utile pour la migration ou la sauvegarde locale.
          </p>
          <Button asChild variant="outline" className="gap-2">
            <a href="/api/backup/download" download target="_blank">
      ...
      <div className="p-4 rounded-md bg-red-50 border border-red-100 flex items-start gap-3 dark:bg-red-950/20 dark:border-red-900/50">
        ...
        <div>
          ...
          <p className="text-sm text-red-700 dark:text-red-400">
            La suppression des données est irréversible. Contactez l'administrateur pour
