...
export const columns: ColumnDef<Ingredient>[] = [
        ...
        cell: ({ row }) => {
            ...
            return (
                <div className="flex flex-col items-start gap-1">
                    ...
                    <Badge variant={isLow ? 'destructive' : 'outline'} className={!isLow ? "bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-950/30 dark:text-emerald-400 dark:border-emerald-800" : ""}>
                        {isLow ? 'BAS' : 'OK'}
                    </Badge>
                </div>
            )
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return <div className="font-mono text-sm text-muted-foreground">{valPerKg.toFixed(2)} €/kg</div>
        }
    },
    {
        id: 'value',
